...
| 製冰機型號、製冰量 | 型號與製冰量（瓦數已有 100W） | 卡片標示 |
| ADAM OUTDOOR 渦輪扇型號 | 確切型號（該品牌多款差異大） | 卡片標示 |
| 簡易焚火台尺寸 | 展開／收納尺寸 | 卡片標示 |
| 電吉拉 mini 實機重量 | 重量 | 客戶在意能不能扛上營位 |
| 5×8 天幕、黑狗穹頂 | 重量與收納尺寸 | 卡片標示 |
| 冰虎 ALPICOOL C40 | 對照實機確認 40L／14kg／60W | 取自公開資料未核對 |

**商品照**：15 項中 8 項已上線（320×320 webp，共 92KB）。仍缺 7 張——
移動冰箱、動力延長線 5M／10M、五米／十米燈條、製冰機、渦輪扇。
卡片 `.ad-photo` 已預留欄位，放圖只需置入 `<img>`。
建議拍自家庫存品；裁切時須移除賣場行銷字樣。
