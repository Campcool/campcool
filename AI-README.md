...
**商品照**：15 項已全部上線（320×320 webp）。2026-08-16 由 Manus 補齊剩餘 6 張：
動力延長線 5M／10M（依老闆指定換 ADAM OUTDOOR 軍綠款）、五米／十米黃光燈條（依老闆指定採逐露天下／逐浪天下 CAMP WORLD 款）、
製冰機（白色桌上型小款，型號未定）、渦輪扇（ADAM OUTDOOR 沙色款）。
檔名慣例 `assets/addon-*.webp`，裁切時已移除賣場行銷字樣。
燈條與製冰機圖取自網路商品圖，正式營業前建議以自家庫存品照片替換（規格同：320×320 webp、直插 `<img>`）。
移動冰箱已於上一輪用實拍圖上線。
